/*
 * ***** SUMMARY *****
 * Spellchecker.c: Suggests candidate words for a misspelled words
*/
...
int main(int argc, char * argv[])
{
	...
	printf("Press enter without any characters to exit\n");
	...
	while (fgets(word, MAX_WORD_LEN, stdin))
	{
	    ...
	    { //assigns hammingDistance position to hammingDistance position
	...
	{ // Prints out 10 closest words by hamming distance
    	...
    	for (int i = 0; i < length; i++)
	{
        	if (a[i] != b[i])
		{
            		...
            		if ((a[i] == b[i]) && (a[i + 1] == b[i + 1]) && (a[i + 2] == b[i + 2]) && (a[i + 3] == b[i + 3]))
			{
            	...
            	if ((a[i] == b[i]) && (a[i + 1] == b[i + 1]) && (a[i + 2] == b[i + 2]) && (a[i + 3] == b[i + 3]) && (a[i + 4] == b[i + 4]))
	    	{
                	hammingDistance--;
            	}
            	...
            	if ((a[i] == b[i]) && (a[i + 1] == b[i + 1]) && (a[i + 2] == b[i + 2]) && (a[i + 3] == b[i + 3]) && (a[i + 4] == b[i + 4]))
		{
            	...
            	if ((a[i] == b[i]) && (a[i + 1] == b[i + 1]) && (a[i + 2] == b[i + 2]) && (a[i + 3] == b[i + 3]) && (a[i + 4] == b[i + 4]) && (a[i + 5] == b[i + 5]))
	    	{
                	hammingDistance--;
            	}
