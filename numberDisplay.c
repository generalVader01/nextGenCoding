...
#include <string.h>
#include <stdlib.h>
#define NUMBER_LENGTH 100 // Length of number fetched
#define TRUE 1     // Useful to understanding the code
#define FALSE 0    // Used when I want to compare if something is == 0 
...
// per-digit basis
void grabMidLevelChars (char num, char * start, char * mid, char * end)
{ // returns bottom chars for any given digit
  if (num == '1')
  {
    *start = '|';
    *mid = ' ';
